...
func getBoard(_ fileName: String) throws -> [[Variable]] {

    // Parse board file into lines.
    let prePath = "/Users/jessededa/Developement/Swift/Futoshiki/Futoshiki"
    let path = URL.init(fileURLWithPath: prePath).appendingPathComponent(fileName)
    let text = try String(contentsOf: path, encoding: String.Encoding.utf8)
    var lines = text.components(separatedBy: "\n")
    lines = lines.compactMap { $0.replacingOccurrences(of: "\r", with: "")} // Bullshit. Bad.
